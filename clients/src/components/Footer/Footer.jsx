            ...
            <div className={styles.footer__container}>
                ...
                <div className={styles.links_block}>
                 ...
                 <div className={styles.links_block}>
                    ...
                    <ul className={styles.menu__block}>
                        <p className={styles.footer_tel}>Моб: <a href="tel:+380678001500">(067) 800-15-00</a></p>   
                        <p className={styles.footer_email}>Email: <a href= "mailto:andrcars.ua@gmail.com">andrcars.ua@gmail.com</a></p>
