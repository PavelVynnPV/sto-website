...
import { conditioner } from "./helper";
    ...
    <section className={styles.service__block}>
      <div className={styles.service__content}>
        ...
        <div className={styles.service__info}>
          ...
          У вашого авто кондиціонера є одне завдання: зробити ваше перебування в
          автомобілі комфортним у спеку. Ваш компресор кондиціонера також
          ...
          незалежно від того, наскільки спекотно на вулиці. Перебування в пробці
          в спекотний день Києва не могли вас турбувати. Тепер, коли минуло
          кілька років, це може бути негаразд. Згодом кондиціонер у вашій машині
          втрачає здатність охолоджувати так само сильно. Це відбувається з
          низки причин: знос кілець, шлангів і ущільнювачів з часом, і навіть
          поломки самого компресора. У будь-якому випадку, через ці проблеми
          часто відбувається витік холодоагенту, що унеможливлює ефективне
          охолодження салону. Ця рідина кондиціонера також становить небезпеку
          ...
          <p className={styles.service__text}>
            <strong>Ми гарантуємо,</strong> що у вашому авто буде приємна прохолода і не буде
            запотівання. Уникайте дорогого ремонту кондиціонування, регулярно
            проходячи перевірку на нашому СТО.
          </p>
